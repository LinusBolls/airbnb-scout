            ...
            (s = function (t) {
              ...
              return (
                ...
                (e.prototype.get = function (t) {
                  ...
                  for (var i = {}, n = 0; n < t.length; n++) {
                    ...
                    e.isObject(t[o])
                      ...
                      : u instanceof e
                      ? (r[o] = u.get())
                      : !e.isFunction(u) && e.isDefined(u) && (r[o] = u);
                  }
                  return i;
                }),
                (e.prototype._collectDefaults = function (t) {
                  var i = [];
                  if (
                    (e.isDefined(t.defaults) && (i = Object.keys(t.defaults)),
                ...
                Object.defineProperty(e, "context", {
                  ...
                  set: function (t) {
                    t.isContext
                      ? (e._audioContext = t)
                      : (e._audioContext = new e.Context(t)),
            ...
            return (
              ...
              (t.Source.prototype.start = function (e, i, n) {
                if (
                  ...
                  (this._state.setStateAtTime(t.State.Started, e), this._synced)
                ) {
              ...
              (t.Buffer = function () {
                ...
                t.call(this),
                  ...
                  e.url instanceof AudioBuffer || e.url instanceof t.Buffer
                    ? (this.set(e.url), this.loaded || (this.onload = e.onload))
                    : t.isString(e.url) &&
              ...
              (t.Buffer.prototype.toMono = function (e) {
                if (t.isNumber(e)) this.fromArray(this.toArray(e));
                  ...
                  for (
                    ...
                    for (var s = this.toArray(o), r = 0; r < s.length; r++)
                      i[r] += s[r];
                  (i = i.map(function (t) {
                    return t / n;
                  })),
              ...
              (t.Buffer.load = function (e, i, n) {
                ...
                return (
                    ...
                    200 === u.status
                      ? t.context
                          ...
                          .catch(function () {
                            t.Buffer._removeFromDownloadQueue(u),
                              l(
                                "Tone.Buffer: could not decode audio data: " + e
                              );
                          })
                  ...
                  u.addEventListener("progress", function (t) {
                    t.lengthComputable &&
                      ((u.progress = (t.loaded / t.total) * 0.95), h());
                  }),
                  u.send(),
                  u
                );
          ...
          (o = function (t) {
            ...
            return (
              ...
              (t.Param.prototype.setValueCurveAtTime = function (e, i, n, o) {
                ...
                for (var s = n / (e.length - 1), r = 1; r < e.length; r++)
          ...
          (o = function (t) {
            ...
            return (
              ...
              (t.Oscillator.prototype.get = function () {
                ...
                return (
                  e.type !== t.Oscillator.Type.Custom && delete e.partials, e
                );
              }),
                ...
                for (var l = 1; l < n; ++l) {
                  ...
                  switch (e) {
                    ...
                    case t.Oscillator.Type.Triangle:
                      (h =
                        1 & l ? u * u * 2 * (((l - 1) >> 1) & 1 ? -1 : 1) : 0),
                        (this._partials[l - 1] = h);
                      break;
                ...
                if (
                  (s > 0
                    ? (this._gainNode.gain.setValueAtTime(0, e),
                      "linear" === this.curve
                        ? this._gainNode.gain.linearRampToValueAtTime(o, e + s)
                ...
                for (var n = e.split(/\W+/), o = 0; o < n.length; o++)
                  if (((e = n[o]), this._events.hasOwnProperty(e)))
                    if (t.isUndef(i)) this._events[e] = [];
                      ...
                      for (var s = this._events[e], r = 0; r < s.length; r++)
                        s[r] === i && s.splice(r, 1);
                return this;
              }),
                ...
                return (
                  ...
                  (t.Param && t.Param === e.constructor)
                    ? (e._param.cancelScheduledValues(0),
                      ...
                      (e.overridden = !0))
                    : e instanceof AudioParam &&
                      (e.cancelScheduledValues(0), e.setValueAtTime(0, 0)),
          ...
          (o = function (t) {
            ...
            return (
                ...
                set: function (t) {
                  ...
                  "pwm" !== this._oscillator.type &&
                    ...
                    t === a.FMOscillator
                      ...
                      : t === a.PulseOscillator
                      ? (this.type = "pulse")
                      : t === a.PWMOscillator && (this.type = "pwm");
                },
              }),
              Object.defineProperty(t.OmniOscillator.prototype, "baseType", {
                ...
                set: function (t) {
                  this.sourceType !== a.PulseOscillator &&
                    this.sourceType !== a.PWMOscillator &&
              ...
              Object.defineProperty(
                ...
                {
                  get: function () {
                    if (this._sourceType === o || this._sourceType === s)
                      return this._oscillator.modulationType;
                  },
                  set: function (t) {
                    (this._sourceType !== o && this._sourceType !== s) ||
            ...
            (t.Noise = function () {
              ...
              Object.defineProperty(t.Noise.prototype, "type", {
                ...
                set: function (i) {
                  if (this._type !== i) {
                    if (!(i in e))
                      throw new TypeError("Tone.Noise: invalid type: " + i);
                    ...
                    for (var e = [], n = 0; n < 2; n++) {
                      ...
                      for (var p = 0; p < 220500; p++) {
                        ...
                        (o = 0.99886 * o + 0.0555179 * f),
                          (s = 0.99332 * s + 0.0750759 * f),
                          (r = 0.969 * r + 0.153852 * f),
                          (a = 0.8665 * a + 0.3104856 * f),
                          (l = 0.55 * l + 0.5329522 * f),
                          (h = -0.7616 * h - 0.016898 * f),
                          (c[p] = o + s + r + a + l + h + u + 0.5362 * f),
                          (c[p] *= 0.11),
                          (u = 0.115926 * f);
                      }
                    }
                ...
                if (o) {
                  ...
                  this.log("decay", h),
                    "linear" === this._decayCurve
                      ? this._sig.linearRampTo(l, o, h + this.sampleTime)
                      : "exponential" === this._decayCurve &&
                        this._sig.exponentialApproachValueAtTime(l, h, o);
                }
                return this;
              }),
              ...
              (t.LowpassCombFilter = function () {
                ...
                t.AudioNode.call(this),
                  (this._combFilter = this.output =
                    new t.FeedbackCombFilter(e.delayTime, e.resonance)),
            ...
            return (
              ...
              (t.TickSource.prototype.forEachTickBetween = function (e, i, n) {
                ...
                if (
                  ...
                  0 !== r && (r = 1 - r);
                  for (
                    var a = this.frequency.getTimeOfTick(s + r), l = null;
                    a < i && this._state;
            ...
            return (
              ...
              (t.TimeBase.prototype.valueOf = function () {
                ...
                if (t.isDefined(this._units)) {
                  ...
                  return r
                    ? s.method.apply(this, r.slice(1))
                    : s.method.call(this, parseFloat(this._val));
                }
                return this._val;
              }),
              ...
              (t.Player.prototype._start = function (e, i, n) {
                ...
                return (
                  ...
                  this._loop && t.isUndef(n)
                    ? s.start(e, i)
                    : s.start(e, i, o - this.toSeconds(this.fadeOut)),
                  this
                );
              }),
            ...
            return (
              ...
              (t.Part.prototype.at = function (e, i) {
                ...
                for (
                  ...
                  if (Math.abs(e.toTicks() - s.startOffset) < n)
                    return t.isDefined(i) && (s.value = i), s;
                }
              ...
              (t.TickSignal.prototype._getTicksUntilEvent = function (e, i) {
                ...
                return (
                  this._events.get(i).time === i &&
                    ...
                    (s = this.getValueAtTime(i - this.sampleTime)),
                  0.5 * (i - e.time) * (o + s) + e.ticks
                );
              }),
            ...
            return (
              ...
              (t.PolySynth.prototype._getClosestVoice = function (e, i) {
                var n = this.voices.find(function (n) {
                  if (
                    Math.abs(n.frequency.getValueAtTime(e) - t.Frequency(i)) <
                      1e-4 &&
            ...
            function o() {
              ...
              if (240 == (240 & r)) {
                ...
                switch (i) {
                  ...
                  case 2:
                    return (
                      (t.type = "copyrightNotice"),
                      (t.text = n.readString(a)),
                      t
                    );
                  case 3:
                    return (
                      (t.type = "trackName"), (t.text = n.readString(a)), t
                    );
                  case 4:
                    return (
                      (t.type = "instrumentName"), (t.text = n.readString(a)), t
                    );
                  case 5:
                  ...
                  case 32:
                    if (((t.type = "channelPrefix"), 1 != a))
                      throw (
                        "Expected length for channelPrefix event is 1, got " + a
                      );
                    return (t.channel = n.readUInt8()), t;
                  case 33:
                    if (((t.type = "portPrefix"), 1 != a))
                      throw (
                        "Expected length for portPrefix event is 1, got " + a
                      );
                    return (t.port = n.readUInt8()), t;
                  case 47:
                    if (((t.type = "endOfTrack"), 0 != a))
                      throw (
                        "Expected length for endOfTrack event is 0, got " + a
                      );
                    return t;
                  case 81:
                  ...
                  case 84:
                    if (((t.type = "smpteOffset"), 5 != a))
                      throw (
                        "Expected length for smpteOffset event is 5, got " + a
                      );
                    var o = n.readUInt8();
                    return (
                  ...
                  case 88:
                    if (((t.type = "timeSignature"), 4 != a))
                      throw (
                        "Expected length for timeSignature event is 4, got " + a
                      );
                    return (
                  ...
                  case 89:
                    if (((t.type = "keySignature"), 2 != a))
                      throw (
                        "Expected length for keySignature event is 2, got " + a
                      );
                    return (t.key = n.readInt8()), (t.scale = n.readUInt8()), t;
                  case 127:
                    return (
                      (t.type = "sequencerSpecific"),
                      (t.data = n.readBytes(a)),
                      t
                    );
                  default:
          ...
          (r.prototype.eof = function () {
            ...
            (t.exports = function (t) {
              ...
              for (
                var a = (function (t) {
                    var e = new r(t),
                      n = { format: e.readUInt16(), numTracks: e.readUInt16() },
                      i = e.readUInt16();
                    return (
                      32768 & i
                        ? ((n.framesPerSecond = 256 - (i >> 8)),
                          (n.ticksPerFrame = 255 & i))
                        : (n.ticksPerBeat = i),
                      n
                    );
                  })(i.data),
          ...
          function r(t, e, r, n) {
            ...
            switch ((t.writeVarInt(a), i)) {
              ...
              case "smpteOffset":
                ...
                var u =
                  (31 & e.hour) |
                  { 24: 0, 25: 32, 29: 64, 30: 96 }[e.frameRate];
                t.writeUInt8(u),
                  t.writeUInt8(e.min),
                  t.writeUInt8(e.sec),
              ...
              case "noteOff":
                (c =
                  ((!1 !== n && e.byte9) || (n && 0 == e.velocity)
                    ? 144
                    : 128) | e.channel) !== r && t.writeUInt8(c),
            ...
            return (
              (t.prototype.update = function () {
                ...
                this.tempos.sort(function (t, e) {
                  ...
                  this.timeSignatures.forEach(function (e, r) {
                    var n =
                        r > 0 ? t.timeSignatures[r - 1] : t.timeSignatures[0],
                      i =
                        (e.ticks - n.ticks) /
                        t.ppq /
                        n.timeSignature[0] /
              ...
              (t.prototype.ticksToMeasures = function (t) {
                ...
                if (-1 !== e) {
                  ...
                  return (
                    r.measures +
                    i / (r.timeSignature[0] / r.timeSignature[1]) / 4
                  );
                }
                return t / this.ppq / 4;
              }),
                      ...
                      for (var e = [], r = 0; r < t.length; r++)
                        for (
                          ...
                          var c = s[o],
                            ...
                            h = c.channel;
                          if (void 0 !== h) {
                            "programChange" === c.type &&
                              (a[h] = c.programNumber);
                            var f = a[h],
                              p = "".concat(f, " ").concat(h);
                            i.has(p)
                              ? (u = i.get(p))
                              : ((u = n + i.size), i.set(p, u));
                          }
            ...
            h = (function () {
              function t(t, e) {
                ...
                if (
                  ((this.name = ""),
                  (this.notes = []),
                  (this.controlChanges = (0, a.createControlChanges)()),
                  (this.pitchBends = []),
                  u.set(this, e),
                  t)
                ) {
                ...
                if (
                  ((this.instrument = new s.Instrument(t, this)),
                  (this.channel = 0),
                  t)
                ) {
                  for (
              ...
              return (
                ...
                (t.prototype.addCC = function (t) {
                  ...
                  return (
                    ...
                    (0, n.insert)(this.controlChanges[r.number], r, "ticks"),
                    this
                  );
                }),
                (t.prototype.addPitchBend = function (t) {
                  ...
                  return (
                    Object.assign(r, t),
                    (0, n.insert)(this.pitchBends, r, "ticks"),
                    this
                  );
                }),
                Object.defineProperty(t.prototype, "duration", {
                ...
                (t.prototype.fromJSON = function (t) {
                  ...
                  void 0 !== t.endOfTrackTicks &&
                    (this.endOfTrackTicks = t.endOfTrackTicks),
                  t.controlChanges))
                    t.controlChanges[r] &&
                ...
                (t.prototype.toJSON = function () {
                  ...
                  return (
                    void 0 !== this.endOfTrackTicks &&
                      (r.endOfTrackTicks = this.endOfTrackTicks),
                    r
                  );
                }),
                t
...
const midiConverterHtml = `<script src="https://unpkg.com/@tonejs/midi"></script>
<script
...
function mount() {
  const terminalSendpanel = document.querySelector("#terminal-sendpanel");
...
class GcodeCommand {
  constructor(gcode, chunkMaxDurationMs = 1000) {
    this.gcode = gcode;
    this.chunks = gcodeToChunks(gcode, chunkMaxDurationMs);
    ...
    console.log("[gcode] chunks:", this.chunks.length);
  }

  playChunk(chunkIndex) {
    if (chunkIndex >= this.chunks.length) {
      console.log("[gcode] All chunks played");
      return;
    }
    ...
    console.log(
      `[gcode] Playing chunk ${chunkIndex}:`,
      getGcodeRunDurationMs(chunk)
    );
  ...
  shouldStartPlayingNextChunk() {
    ...
    const currentChunkDuration = getGcodeRunDurationMs(
      this.chunks[this.lastPlayedChunkIndex]
    );
...
function getGcodeRunDurationMs(input) {
  const regex = /\sP(\d+)/g;
  let sum = 0;
  let match;
...
function gcodeToChunks(gcode, chunkMaxDurationMs = 1000) {
...
function mountExternalCode() {
  ...
  function handleMidi() {
    ...
    const tempoMultiplier =
      1 / Math.max(document.getElementById("speedMultiplierInput").value, 0.01);
  ...
  document
    ...
    .addEventListener("click", () => {
      const gcode = document.getElementById("outputArea").value;

      command = new GcodeCommand(gcode);
      // play(document.getElementById("outputArea").value);
